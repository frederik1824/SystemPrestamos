<aside class="h-screen w-64 fixed left-0 top-0 border-r-0 bg-slate-50 flex flex-col py-6 z-50 transition-transform duration-300 ease-in-out lg:translate-x-0" :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'">
    <div class="px-8 mb-10 flex items-center gap-3 group">
        ...
        <div>
            ...
            <p class="text-[0.625rem] font-bold text-slate-500 uppercase tracking-widest mt-1">Core System</p>
        </div>
    </div>
    ...
    <div class="px-6 mt-auto pt-6 border-t border-slate-100">
        <a href="#" class="flex items-center gap-3 p-2 bg-white rounded-xl hover:bg-slate-100 transition-colors group">
    ...
    <div class="px-6 mt-auto pt-6 border-t border-slate-100">
        <div class="flex items-center gap-3 p-2 bg-slate-50 rounded-xl">
            ...
            <div class="overflow-hidden">
                <p class="text-[0.75rem] font-bold text-slate-500 truncate tracking-tighter uppercase italic">Modo Invitado</p>
            </div>
        </div>
    </div>
    @endguest
